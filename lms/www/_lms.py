...
def get_context():
	...
	favicon = frappe.db.get_single_value("Website Settings", "favicon") or "/assets/lms/frontend/learning.svg"
	title = frappe.db.get_single_value("Website Settings", "app_name") or "BILUXURY Academy"
